...
public class MyOpenHelper extends SQLiteOpenHelper {
    ...
    public static final String filename = "MyChatDatabase";
    ...
    public void onCreate(SQLiteDatabase db) {
        //Create table MyData ( _id INTEGER PRIMARY KEY AUTOINCREMENT, Message TEXT, SendOrReceive BOOLEAN, TimeSent TEXT );
        String result = String.format(" %s %s %s", "FirstString" , true, "10.0" );

        //                                      //TABLE_NAME               take care of id numbers
        db.execSQL( String.format( "Create table %s ( %s INTEGER PRIMARY KEY AUTOINCREMENT, %s TEXT, %s  BOOLEAN, %s TEXT );"
